...
ENABLE_QUANTGRAD_CONV_INPUTS=1
ENABLE_QUANTGRAD_CONV_OUTPUTS=1
...
ENABLE_QUANTGRAD_MATMUL_INPUTS=0
...
# True=1, False=0 Unsigned activations (weights remain signed )
QUANTEMU_CONV_UNSIGNED_ACTS=0 
QUANTEMU_CONV_UNSIGNED_GRAD=0 
QUANTEMU_CONV_PRUNING_INPUTS=0
QUANTEMU_CONV_PRUNING_FILTER=0
...
QUANTEMU_CBLOCK_TYPE_CONV_GRAD=2
...
export ENABLE_QUANTGRAD_MATMUL_INPUTS
...
export QUANTEMU_CONV_UNSIGNED_ACTS
export QUANTEMU_CONV_UNSIGNED_GRAD
export QUANTEMU_CONV_PRUNING_INPUTS
export QUANTEMU_CONV_PRUNING_FILTER
export QUANTEMU_FIRST_LAYER_PRECISION
export QUANTEMU_PRECISION_CONV_INPUTS
export QUANTEMU_PRECISION_CONV_FILTER
export QUANTEMU_PRECISION_CONV_OUTPUTS
export QUANTEMU_PRECISION_CONV_GRAD
export QUANTEMU_PRECISION_LSTM_INPUTS
export QUANTEMU_PRECISION_LSTM_FILTER
export QUANTEMU_PRECISION_LSTM_GRAD
