...
bazel build --config=opt --config=cuda //tensorflow/core/user_ops:quantemu.so
bazel build --config=opt --config=cuda //tensorflow/core/user_ops:quantemu_op_py
bazel build --config=opt --config=cuda //tensorflow/python/tools:freeze_graph
