...
def quantize_emu(input, data_format='channels_last', allocate_copy=0, output_data_type=0, output_precision=23, output_exponent_bits=5, channel_blocking_type=0, input_channels_per_block=4096, round_mode=0, quantize_gradients=0, quantize_gradients_only=0):
